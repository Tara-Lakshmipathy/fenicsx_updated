...
def ElasticConstants(
        ...
        parameters: InputElasticTensor.dataclass|None = InputElasticTensor.dataclass(),
...
def SymmetryAnalysis(
        structure, parameters: InputElasticTensor.dataclass|None
...
def GenerateStructures(
        ...
        parameters: InputElasticTensor.dataclass|None = None,
):
    structure_dict = {}
...
def RotateElasticityTensor(
    elastic,
    crystal: str,
    x_indices: str|list[int] = '1 0 0',
    y_indices: str|list[int] = '0 1 0',
    z_indices: str|list[int] = '0 0 1',
    print_tensor: bool = True,
):
    '''
